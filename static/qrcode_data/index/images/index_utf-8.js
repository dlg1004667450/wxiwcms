    ...
    addEvent("qrcodeform", "submit", function(event){
        ...
        if(object.getError().length){
            ...
            if(object.getString()){
                ...
                var urL = "http://127.0.0.1/weixin/up/teest?text=" + encodeURIComponent(object.getString())+colorParam;
               $('bigcode').innerHTML='<a href="http://127.0.0.1/weixin/upload/20160410/test.png" target="_blank"><img src="http://127.0.0.1/weixin/upload/20160410/test.png" id="qrcodeimg"/></a>';
            }else{
